...
NUCL   = ['A','C','G','U']
STOP   = ['UAA', 'UGA', 'UAG']
iupacDict = {'A':['A'],'C':['C'],'G':['G'],'U':['U'],'R':['A','G'],'Y':['C','U'],'S':['G','C'],
...
def printusage(exe):
	text = """
Usage: %s peptide1 peptide2 -n numSamples -c constraint -m BlosumMatrix -t threshold -gc GC_content -r 0|1 -w
...
6) sampling with or w/o replacement
7) Representative sampling """ % exe
	print text
	text = """
